    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <h1 className="text-3xl font-bold mb-8">에스엔씨컴퍼니 서비스 이용약관</h1>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제1조 (목적)</h2>
            <p className="text-muted-foreground leading-relaxed">
              이 약관은 에스엔씨컴퍼니(이하 "회사"라 함)이 제공하는 서비스의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제2조 (정의)</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제3조 (약관 외 준칙)</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제4조 (약관의 효력과 변경)</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제5조 (이용계약의 체결)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제6조 (회원정보의 변경)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제7조 (개인정보보호 의무)</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제8조 (회원의 아이디 및 비밀번호의 관리에 대한 의무)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제9조 (이용자의 의무)</h2>
            <div className="space-y-4">
              <div>
                <p className="text-muted-foreground leading-relaxed mb-2">1. 이용자는 다음 행위를 하여서는 안 됩니다.</p>
                <ol className="list-inside space-y-2 text-muted-foreground ml-4">
                  <li className="ml-4">1) 신청 또는 변경 시 허위 내용의 등록</li>
                  <li className="ml-4">2) 타인의 정보 도용</li>
                  <li className="ml-4">3) 회사가 게시한 정보의 변경</li>
                  <li className="ml-4">4) 회사가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시</li>
                  <li className="ml-4">5) 회사와 기타 제3자의 저작권 등 지식재산권에 대한 침해</li>
                  <li className="ml-4">6) 회사 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위</li>
                  <li className="ml-4">7) 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 서비스에 공개 또는 게시하는 행위</li>
                  <li className="ml-4">8) 기타 불법적이거나 부당한 행위</li>
                </ol>
              </div>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제10조 (서비스의 제공 및 변경)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
              <li>회사는 다음과 같은 서비스를 제공합니다: 온라인 셀러 익명 커뮤니티</li>
              <li>회사는 상당한 이유가 있는 경우에 운영상, 기술상의 필요에 따라 제공하고 있는 서비스를 변경할 수 있습니다.</li>
              <li>회사는 이용자에게 서비스를 제공함에 있어 관련 법령, 약관, 운영정책 및 공지사항 등에서 정한 바에 따라 무료 및 유료로 서비스를 제공합니다.</li>
            </ol>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제11조 (서비스의 중단)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제12조 (회원탈퇴 및 자격 상실 등)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
              <li>회원은 회사에 언제든지 탈퇴를 요청할 수 있으며 회사는 즉시 회원탈퇴를 처리합니다.</li>
              <li className="leading-relaxed">
                회원이 다음 각 호의 사유에 해당하는 경우, 회사는 회원자격을 제한 및 정지시킬 수 있습니다.
                <ol className="list-inside space-y-2 mt-2 ml-4">
                  <li className="ml-4">1) 가입 신청 시에 허위 내용을 등록한 경우</li>
                  <li className="ml-4">2) 다른 사람의 서비스 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우</li>
                  <li className="ml-4">3) 서비스를 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</li>
                </ol>
              </li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제13조 (정보의 제공 및 광고의 게재)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
              <li>회사는 회원이 서비스 이용 중 필요하다고 인정되는 다양한 정보를 공지사항이나 앱/웹 내 알림 등의 방법으로 회원에게 제공할 수 있습니다.</li>
              <li>회원은 관련 법령에 따른 거래관련 정보 및 고객문의 등에 대한 답변 등을 제외하고는 언제든지 위 정보제공에 대하여 수신 거절을 할 수 있습니다.</li>
              <li>회사는 서비스의 운영과 관련하여 서비스 화면, 홈페이지, 전자우편 등에 광고를 게재할 수 있습니다. 광고가 게재된 전자우편을 수신한 회원은 수신 거절을 회사에게 할 수 있습니다.</li>
            </ol>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제14조 (서비스 이용시간)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제15조 (서비스 이용 제한)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제16조 (유료서비스의 이용)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제17조 (포인트 및 쿠폰)</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제18조 (환불)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제19조 (유료서비스의 결제 등)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
              <li>회원은 유료서비스 이용 시 다음 각 호의 결제수단을 이용할 수 있습니다: 카드결제, 계좌이체, ARS, 휴대전화</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제20조 (게시물의 관리)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제21조 (게시물의 저작권)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
              ...
              <li className="leading-relaxed">
                회사는 서비스 내에 게시된 회원의 게시물을 다음 각 호의 목적으로 사용할 수 있습니다.
                <ol className="list-inside space-y-2 mt-2 ml-4">
                  <li className="ml-4">1) 게시물을 변형하여 2차적 저작물을 작성하는 경우</li>
                  <li className="ml-4">2) 미디어, 통신사 등을 통한 홍보 목적으로 사용하는 경우</li>
                  <li className="ml-4">3) 서비스 개선 및 신규 서비스 개발 등에 활용하는 경우</li>
                </ol>
              </li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제22조 (책임제한)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제23조 (준거법 및 재판관할)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 mt-8">제24조 (기타)</h2>
            <ol className="list-decimal list-inside space-y-3 text-muted-foreground ml-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold mb-4 mt-8">부칙</h2>
            <p className="text-muted-foreground leading-relaxed">
              이 약관은 2025-10-19부터 시행합니다.
            </p>
          </section>
